<template>
  <div>
    <div class="container">
      <aside class="style" v-bind:class="{ stylee: falase }">
        <ul>
          <li>
          ...
          <li>
            ...
            <router-link to="/foo"> نظرات </router-link>
          </li>
          <li>
            <svg
              xmlns="http://www.w3.org/2000/svg"
            ...
            <router-link to="/foo"> آدرس ها </router-link>
          </li>
          <li>
            <svg
              xmlns="http://www.w3.org/2000/svg"
          ...
          <li>
            ...
            <router-link to="/foo"> سفارش های من </router-link>
          </li>
          <li>
            <svg
              xmlns="http://www.w3.org/2000/svg"
            ...
            <router-link to="/user/profile/test"> اطلاعات حساب </router-link>
          </li>
        </ul>
      </aside>
